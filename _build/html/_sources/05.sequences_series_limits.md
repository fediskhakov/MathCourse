...
- {cite:ps}`5-ayres2013`
- {cite:ps}`5-basov2011`
- {cite:ps}`5-haeussler1987`: Chapters 6 and 10 (pp. 164–193 and 375–402).
- {cite:ps}`5-shannon1995`: Chapters 1.6, 6.6, and 7 (pp. 19–25, 252–256, and 285–355).
- {cite:ps}`5-sydsaeter2016`: Chapters 2.8, 2.9, 2.10, 2.11, 6.5, 7.9, 7.11, and 10 (pp. 52–62, 182–188, 257–266, 270–273, and 375–406).

### More advanced references
- {cite:ps}`5-banks2009`
- {cite:ps}`5-corbae2009`: Chapters 3, 4 and 6 (pp. 72-171 and 259-354).
- {cite:ps}`5-kolmogorov1970`: Chapters 2 and 3 (pp. 37-117).
- {cite:ps}`5-simon1994`: Chapters 12 and 29 (pp. 253-272 and 803-821).
- {cite:ps}`5-spiegel1981a`: Chapters 2 and 3 (pp. 20-56).
- {cite:ps}`5-takayama1993`: Chapter 1 (pp. 3-71).
...
### The Peano axioms
This material is drawn from {cite:ps}`5-banks2009` (pp. 2-13).
...
The validity of the method of proof by induction can actually be established through a proof by contradiction. See {cite:ps}`5-kolmogorov1970` (p. 28) for details.

The method of proof by induction can be extended beyond the set of natural numbers to any “well-ordered set”, where “well-ordered” has a very precise mathematical meaning. This extended version of proof by induction is known as “proof by transfinite induction”. See {cite:ps}`5-kolmogorov1970` (pp. 28-29) for details.

#### Examples

This example comes from {cite:ps}`5-simon1994` (pp. 856-857).
...
This example comes from Exercise A.1.7 in {cite:ps}`5-simon1994` (p. 858).
...
As is noted in {cite:ps}`5-shannon1995` (p. 302), this formula has a very simple interpretation. It is simply the number of terms in the sequence that are being summed times the average of the first and last terms in that sequence.

**Claim:** $\sum\limits^{N+1}_{n=1} (a + (n − 1) d ) = \frac{(2a+Nd )(N+1)}{2}$.

**Proof:** (Note that the following proof is based on the one that is provided in {cite:ps}`5-basov2011` (pp. 22-23). By mathematical induction on $N$.
...
### Types of Annuities
There are many types of annuities. Using the terminology that is employed by {cite:ps}`5-shannon1995`, these include the following:
