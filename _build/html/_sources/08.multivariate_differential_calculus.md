...
- {cite:ps}`8-bradley2008`: Chapter 7, Sections 1 to 3 (pp. 360-408).
- {cite:ps}`8-haeussler1987`: Chapter 17, Sections 1 to 7 and Sections 9 to 10 (pp. 668-706 and 714-723).
- {cite:ps}`8-shannon1995`: Chapter 10, Sections 1 to 6 (pp. 450-489).
- {cite:ps}`8-sydsaeter2016`: Chapters 11 and 12 (pp. 407-494).

### Intermediate mathematical economics textbooks
- {cite:ps}`8-chiang1984`: Chapters 6-8 and Chapter 10 (pp. 127-227 and 268-306).
- {cite:ps}`8-chiang2005`: Chapters 6 to 10 (pp. 124-290).
- {cite:ps}`8-simon1994`: Chapters 2 to 5 (pp. 10-103).

### Mathematics textbooks
- {cite:ps}`8-spiegel1981a`: Chapters 4, 6, 7 and 8; pp. 57-79 and 101-179.
- {cite:ps}`8-spiegel1981b`: Chapters 3 and 4; pp. 35-81.
...
An example in which Young's theorem cannot be applied because the underlying function is not twice continuously differentiable at the point of interest is provided by {cite:ps}`8-spiegel1981a` (p. 126, Worked Problem 43). This example is presented below.
...
This is Theorem 15.2 in {cite:ps}`8-simon1994` (p. 341).
...
This is Theorem 15.9 in {cite:ps}`8-simon1994` (p. 367).
...
A discussion of homotheticity can be found in {cite:ps}`8-simon1994` (pp. 483 and 500-504).
...
It is straightforward to explicitly derive this result from the definition of homogeneity of degree $r$. The following proof is based on the one in {cite:ps}`8-haeussler1987` (p. 723).
