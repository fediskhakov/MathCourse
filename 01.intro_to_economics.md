...
- {cite:ps}`1-alchian1972`: Chapters 1, 2, 3, 4, and 20 (pp. 2–52 and 384–404).
- {cite:ps}`1-alchian1983`: Chapter 1 (pp. 1–12).
- {cite:ps}`1-ausubel1993`
- {cite:ps}`1-case2017`: Chapter 1 (pp. 3–26).
- {cite:ps}`1-gans2018`: Chapters 1, 2, and 3 (pp. 4–67).
- {cite:ps}`1-gravelle2004`: Chapter 1 (pp. 1–10). 
- {cite:ps}`1-hamermesh2006`: Chapter 1 (pp. 3–14).
- {cite:ps}`1-heyne2000`
- {cite:ps}`1-heyne2014`: Chapters 1 and 2 (pp. 1–44).
- {cite:ps}`1-hirshleifer2005`: Chapter 1 (pp. 2–26).
- {cite:ps}`1-kunimoto2010`, p. 6. 
- {cite:ps}`1-malinvaud1972`: p. 1.
- {cite:ps}`1-mankiw2003`: Chapter 1 (pp. 2-14).
- {cite:ps}`1-perloff2014`: Chapter 1 (pp. 23–30).
- {cite:ps}`1-robbins1984`
- {cite:ps}`1-vohra2005`: the Preface only.
- {cite:ps}`1-waud1989`: Chapters 8-10 (pp. 169-249).
...
-- (From page one of {cite:ps}`1-malinvaud1972`.)
...
According to {cite:ps}`1-ausubel1993` (p. 99): 
...
-- From page 99 of {cite:ps}`1-ausubel1993`.
