...
We want to extend our discussion of differential calculus from single-real-valued univariate functions, $f(x_1)$, to single-real-valued multivariate, $f(x_1,x_2,\dots,x_n)$.

We will be focussing on two concepts. These are **partial derivatives** and **total differentiation**.
```
